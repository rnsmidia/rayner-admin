...
<div style="padding:20px 40px;border-top:1px solid rgba(255,255,255,.06);text-align:center;">
  ...
  if (action === 'blast-cenadrop') {
    ...
    const SUBJECT = 'Seu personagem muda de rosto em cada cena? ⚡ Aula ao vivo HOJE 20h';
...
<tr><td align="center" style="padding: 32px 16px;">
  <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px; width:100%; background-color:#08081a; border-radius:20px; overflow:hidden; box-shadow:0 0 0 1px rgba(124,111,255,0.2), 0 40px 80px rgba(0,0,0,0.6);">
          ...
          <tr>
            <td align="center">
              <div style="display:inline-block; background:rgba(0,0,0,0.4); border:1px solid rgba(124,111,255,0.35); border-radius:16px; padding:24px 40px;">
                ...
                <div style="font-size:52px; font-weight:800; color:#ffffff; line-height:1; font-family:Arial,sans-serif;">HOJE <span style="color:#7c6fff;">20H</span></div>
    ...
    <tr><td><div style="height:3px; background:linear-gradient(90deg, transparent, #7c6fff, #c084fc, #7c6fff, transparent);"></div></td></tr>
  </table>
</td></tr>
</table>
</body>
